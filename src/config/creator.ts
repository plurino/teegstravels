  ...
  faqs: [
    {
      ...
      answer: "Teegs (Tegan Johnson) is a British solo travel creator known online as @itsnottegxnn. On July 1, 2026, she left the UK on a one-way ticket to explore the world, sharing candid YouTube vlogs and TikTok Lives as she figures out life on the road."
    },
    {
    ...
    },
    {
      ...
      answer: "Teegs is traveling on an open-ended one-way ticket journey. To see where she is right now, check out her latest YouTube vlogs and TikTok Lives to stay up to date!"
    }
  ]
};
